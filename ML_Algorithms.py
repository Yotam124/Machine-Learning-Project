...
# ------------------------------------------------ SVM with PCA ------------------------------------------------
def svm_with_pca(train_set, train_classes, test_set, test_classes, encoded_classes):
    X = scale(test_set)
    y = scale(train_set)
    ...
    plt.figure(figsize=(18, 13))
    plot_confusion_matrix(cnf_matrix, classes=encoded_classes,
                          title='SVM with PCA', rotation=rotation)
...
def adaboost(train_set, train_classes, test_set, test_classes, encoded_classes):
    n_estimators = 100

    model = AdaBoostClassifier(n_estimators=n_estimators, base_estimator=None, learning_rate=1, random_state=1)
    ...
    plt.figure(figsize=(18, 13))
    plot_confusion_matrix(cnf_matrix, classes=encoded_classes,
                          title='adaboost', rotation=rotation)


def linear_regression(train_set, train_classes, test_set, test_classes, encoded_classes):
    ...
    print(r2_score(test_classes, predicted_labels))
...
# ------------------------------------------------------------------------------------------------------------------
# ------------------------------------------------ Algorithms for 1 song classification ----------------------------
# ------------------------------------------------------------------------------------------------------------------
...
def knn_song_clf(train_set, train_classes, test_set, test_classes, encoded_classes):
    ...
    print('------------------------ KNN-single-song - Evaluation ------------------------')
...
def svm_song_clf(train_set, train_classes, test_set, test_classes, encoded_classes):
    # model_svm = LinearSVC(random_state=0, tol=1e-5, max_iter=5000)
    svclassifier = SVC(kernel='rbf', C=10.0, gamma=0.1)
    ...
    print('------------------------ SVM-single-song - Evaluation ------------------------')
    print('Threshold: ', math.sqrt(len(label_count)) - 1)
    print('Predicted labels: ', predicted_decoded_labels)
    print('Predicted labels: ', label_count)
    print('Threshold label: ', threshold_label)
...
def rf_song_clf(train_set, train_classes, test_set, test_classes, encoded_classes):
    n_estimators = 100
    ...
    print('------------------------ Random Forest-single-song - Evaluation ------------------------')
    print('Threshold: ', math.sqrt(len(label_count)) - 1)
    print('Predicted labels: ', predicted_decoded_labels)
    print('Predicted labels: ', label_count)
    print('Threshold label: ', threshold_label)
